...
export default function Team() {
        ...
        pt: [
            {
                ...
                email: "lays.nogueira@qualittus.com",
            },
            {
                name: "Davi Balan",
                ...
                email: "davi.balan@qualittus.com",
            },
        ],
        en: [
            {
    ...
    const content = {
        pt: {
            ...
            subtitle: "Conheça quem está à frente da Qualittus",
            description: "Nossa equipe executiva combina experiência sólida com visão inovadora para conduzir a Qualittus rumo ao futuro da qualidade e tecnologia.",
        },
        en: {
            title: "Our Leadership",
            subtitle: "Meet the people leading Qualittus",
            description: "Our executive team combines solid experience with innovative vision to lead Qualittus toward the future of quality and technology.",
        },
    };
